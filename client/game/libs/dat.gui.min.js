...
dat.utils.common = function(){ var e = Array.prototype.forEach,a = Array.prototype.slice;return { BREAK:{},
...
each:function(a,d,f){ if (e && a.forEach === e)a.forEach(d,f);else if (a.length === a.length + 0) for (var b = 0,n = a.length;b < n;b++){ if (b in a && d.call(f,a[b],b) === this.BREAK) break; } else for (b in a) if (d.call(f,a[b],b) === this.BREAK) break; },
...
dat.controllers.Controller = function(e){ var a = function(a,d){ this.initialValue = a[d];this.domElement = document.createElement('div');this.object = a;this.property = d;this.__onFinishChange = this.__onChange = void 0; };e.extend(a.prototype,{ onChange:function(a){ this.__onChange = a;return this; },
onFinishChange:function(a){ this.__onFinishChange = a;return this; },
setValue:function(a){ this.object[this.property] = a;this.__onChange && this.__onChange.call(this,a);this.updateDisplay();return this; },
getValue:function(){ return this.object[this.property]; },
updateDisplay:function(){ return this; },
isModified:function(){ return this.initialValue !== this.getValue(); } });return a; }(dat.utils.common);
...
makeFullscreen:function(b,a,d){ e.isUndefined(a) && (a = true);e.isUndefined(d) && (d = true);b.style.position = 'absolute';if (a)b.style.left = 0,b.style.right = 0;if (d)b.style.top = 0,b.style.bottom = 0; },
fakeEvent:function(b,a,d,f){ var d = d || {},m = c[a];if (!m) throw Error('Event type ' + a + ' not supported.');var l = document.createEvent(m);switch (m){ case 'MouseEvents':l.initMouseEvent(a,d.bubbles || false,d.cancelable || true,window,d.clickCount || 1,0,0,d.x || d.clientX || 0,d.y || d.clientY ||
0,false,false,false,false,0,null);break;case 'KeyboardEvents':m = l.initKeyboardEvent || l.initKeyEvent;e.defaults(d,{ cancelable:true,ctrlKey:false,altKey:false,shiftKey:false,metaKey:false,keyCode:void 0,charCode:void 0 });m(a,d.bubbles || false,d.cancelable,window,d.ctrlKey,d.altKey,d.shiftKey,d.metaKey,d.keyCode,d.charCode);break;default:l.initEvent(a,d.bubbles || false,d.cancelable || true); }e.defaults(l,f);b.dispatchEvent(l); },
bind:function(b,a,d,c){ b.addEventListener ? b.addEventListener(a,d,c || false) : b.attachEvent &&
...
addClass:function(b,a){ if (b.className === void 0)b.className = a;else if (b.className !== a){ var d = b.className.split(/ +/);if (d.indexOf(a) == -1)d.push(a),b.className = d.join(' ').replace(/^\s+/,'').replace(/\s+$/,''); } return f; },
removeClass:function(b,a){ if (a){ if (b.className !== void 0) if (b.className === a)b.removeAttribute('class');else { var d = b.className.split(/ +/),
c = d.indexOf(a);if (c != -1)d.splice(c,1),b.className = d.join(' '); } } else b.className = void 0;return f; },
...
isActive:function(a){ return a === document.activeElement && (a.type || a.href); } };return f; }(dat.utils.common);
...
step:function(a){ this.__step = a;return this; } });return c; }(dat.controllers.Controller,dat.utils.common);
...
updateDisplay:function(){ this.getValue() === true ? (this.__checkbox.setAttribute('checked','checked'),this.__checkbox.checked = true) : this.__checkbox.checked = false;return d.superclass.prototype.updateDisplay.call(this); } });return d; }(dat.controllers.Controller,dat.dom.dom,dat.utils.common);
...
dat.color.interpret = function(e,a){ var c,d,f = [{ litmus:a.isString,
conversions:{ THREE_CHAR_HEX:{ read:function(a){ a = a.match(/^#([A-F0-9])([A-F0-9])([A-F0-9])$/i);return a === null ? false : { space:'HEX',hex:parseInt('0x' + a[1].toString() + a[1].toString() + a[2].toString() + a[2].toString() + a[3].toString() + a[3].toString()) }; },write:e },
SIX_CHAR_HEX:{ read:function(a){ a = a.match(/^#([A-F0-9]{6})$/i);return a === null ? false : { space:'HEX',hex:parseInt('0x' + a[1].toString()) }; },write:e },
CSS_RGB:{ read:function(a){ a = a.match(/^rgb\(\s*(.+)\s*,\s*(.+)\s*,\s*(.+)\s*\)/);
return a === null ? false : { space:'RGB',r:parseFloat(a[1]),g:parseFloat(a[2]),b:parseFloat(a[3]) }; },
write:e },
CSS_RGBA:{ read:function(a){ a = a.match(/^rgba\(\s*(.+)\s*,\s*(.+)\s*,\s*(.+)\s*\,\s*(.+)\s*\)/);return a === null ? false : { space:'RGB',r:parseFloat(a[1]),g:parseFloat(a[2]),b:parseFloat(a[3]),a:parseFloat(a[4]) }; },write:e } } },{ litmus:a.isNumber,conversions:{ HEX:{ read:function(a){ return { space:'HEX',hex:a,conversionName:'HEX' }; },write:function(a){ return a.hex; } } } },{ litmus:a.isArray,
conversions:{ RGB_ARRAY:{ read:function(a){ return a.length !=
3 ? false : { space:'RGB',r:a[0],g:a[1],b:a[2] }; },
write:function(a){ return [a.r,a.g,a.b]; } },
RGBA_ARRAY:{ read:function(a){ return a.length != 4 ? false : { space:'RGB',r:a[0],g:a[1],b:a[2],a:a[3] }; },write:function(a){ return [a.r,a.g,a.b,a.a]; } } } },{ litmus:a.isObject,
conversions:{ RGBA_OBJ:{ read:function(b){ return a.isNumber(b.r) && a.isNumber(b.g) && a.isNumber(b.b) && a.isNumber(b.a) ? { space:'RGB',r:b.r,g:b.g,b:b.b,a:b.a } : false; },write:function(a){ return { r:a.r,g:a.g,b:a.b,a:a.a }; } },
RGB_OBJ:{ read:function(b){ return a.isNumber(b.r) &&
...
HSV_OBJ:{ read:function(b){ return a.isNumber(b.h) && a.isNumber(b.s) && a.isNumber(b.v) ? { space:'HSV',h:b.h,s:b.s,v:b.v } : false; },write:function(a){ return { h:a.h,s:a.s,v:a.v }; } } } }];return function(){ d =
...
remove:function(){ c.__gui.remove(c);return c; } });if (c instanceof j){ var e = new h(c.object,c.property,{ min:c.__min,max:c.__max,step:c.__step });i.each(['updateDisplay','onChange','onFinishChange'],function(a){ var b = c[a],H = e[a];c[a] = e[a] = function(){ var a = Array.prototype.slice.call(arguments);b.apply(c,a);return H.apply(e,a); }; });
...
true;var e = u && localStorage.getItem(document.location.href + '.isLocal') === 'true';Object.defineProperties(this,{ parent:{ get:function(){ return a.parent; } },
scrollable:{ get:function(){ return a.scrollable; } },
autoPlace:{ get:function(){ return a.autoPlace; } },
preset:{ get:function(){ return d.parent ? d.getRoot().preset : a.load.preset; },
set:function(b){ d.parent ? d.getRoot().preset = b : a.load.preset = b;for (b = 0;b < this.__preset_select.length;b++) if (this.__preset_select[b].value == this.preset) this.__preset_select.selectedIndex =
b;d.revert(); } },
width:{ get:function(){ return a.width; },set:function(b){ a.width = b;D(d,b); } },
name:{ get:function(){ return a.name; },set:function(b){ a.name = b;if (m)m.innerHTML = a.name; } },
closed:{ get:function(){ return a.closed; },set:function(b){ a.closed = b;a.closed ? g.addClass(d.__ul,k.CLASS_CLOSED) : g.removeClass(d.__ul,k.CLASS_CLOSED);this.onResize();if (d.__closeButton)d.__closeButton.innerHTML = b ? k.TEXT_OPEN : k.TEXT_CLOSED; } },
load:{ get:function(){ return a.load; } },
useLocalStorage:{ get:function(){ return e; },
set:function(a){ u &&
...
false);i.extend(k.prototype,{ add:function(a,b){ return q(this,a,b,{ factoryArgs:Array.prototype.slice.call(arguments,2) }); },
addColor:function(a,b){ return q(this,a,b,{ color:true }); },
remove:function(a){ this.__ul.removeChild(a.__li);this.__controllers.slice(this.__controllers.indexOf(a),1);var b = this;i.defer(function(){ b.onResize(); }); },
destroy:function(){ this.autoPlace && v.removeChild(this.domElement); },
addFolder:function(a){ if (this.__folders[a] !== void 0) throw Error('You already have a folder in this GUI by the name "' +
...
onResize:function(){ var a = this.getRoot();if (a.scrollable){ var b = g.getOffset(a.__ul).top,c = 0;i.each(a.__ul.childNodes,function(b){ a.autoPlace && b === a.__save_row || (c +=
g.getHeight(b)); });window.innerHeight - b - 20 < c ? (g.addClass(a.domElement,k.CLASS_TOO_TALL),a.__ul.style.height = window.innerHeight - b - 20 + 'px') : (g.removeClass(a.domElement,k.CLASS_TOO_TALL),a.__ul.style.height = 'auto'); }a.__resize_handle && i.defer(function(){ a.__resize_handle.style.height = a.__ul.offsetHeight + 'px'; });if (a.__closeButton)a.__closeButton.style.width = a.width + 'px'; },
remember:function(){ if (i.isUndefined(x))x = new y,x.domElement.innerHTML = a;if (this.parent) throw Error('You can only call remember on a top level GUI.');
...
getSaveObject:function(){ var a = this.load;a.closed = this.closed;if (this.__rememberedObjects.length > 0){ a.preset = this.preset;if (!a.remembered)a.remembered = {};a.remembered[this.preset] = z(this); }a.folders = {};i.each(this.__folders,function(b,
c){ a.folders[c] = b.getSaveObject(); });return a; },
save:function(){ if (!this.load.remembered) this.load.remembered = {};this.load.remembered[this.preset] = z(this);B(this,false); },
saveAs:function(a){ if (!this.load.remembered) this.load.remembered = {},this.load.remembered[w] = z(this,true);this.load.remembered[a] = z(this);this.preset = a;C(this,a,true); },
revert:function(a){ i.each(this.__controllers,function(b){ this.getRoot().load.remembered ? t(a || this.getRoot(),b) : b.setValue(b.initialValue); },this);i.each(this.__folders,
function(a){ a.revert(a); });a || B(this.getRoot(),false); },
listen:function(a){ var b = this.__listening.length == 0;this.__listening.push(a);b && E(this.__listening); } });return k; }(dat.utils.css,'<div id="dg-save" class="dg dialogue">\n\n  Here\'s the new load parameter for your <code>GUI</code>\'s constructor:\n\n  <textarea id="dg-new-constructor"></textarea>\n\n  <div id="dg-save-locally">\n\n    <input id="dg-local-storage" type="checkbox"/> Automatically save\n    values to <code>localStorage</code> on exit.\n\n    <div id="dg-local-explain">The values saved to <code>localStorage</code> will\n      override those passed to <code>dat.GUI</code>\'s constructor. This makes it\n      easier to work incrementally, but <code>localStorage</code> is fragile,\n      and your friends may not see the same values you do.\n      \n    </div>\n    \n  </div>\n\n</div>',
...
set:function(a){ this.__state.space = 'HEX';this.__state.hex = a; } });return j; }(dat.color.interpret,dat.color.math = function(){ var e;return { hsv_to_rgb:function(a,c,d){ var e = a / 60 - Math.floor(a / 60),b = d * (1 - c),n = d * (1 - e * c),c = d * (1 - (1 - e) * c),a = [[d,c,b],[n,d,b],[b,d,c],[b,n,d],[c,b,d],[d,b,n]][Math.floor(a / 60) % 6];return { r:a[0] * 255,g:a[1] * 255,b:a[2] * 255 }; },
rgb_to_hsv:function(a,c,d){ var e = Math.min(a,c,d),b = Math.max(a,c,d),e = b - e;if (b == 0) return { h:NaN,s:0,v:0 };
a = a == b ? (c - d) / e : c == b ? 2 + (d - a) / e : 4 + (a - c) / e;a /= 6;a < 0 && (a += 1);return { h:a * 360,s:e / b,v:b / 255 }; },
rgb_to_hex:function(a,c,d){ a = this.hex_with_component(0,2,a);a = this.hex_with_component(a,1,c);return a = this.hex_with_component(a,0,d); },
component_from_hex:function(a,c){ return a >> c * 8 & 255; },
hex_with_component:function(a,c,d){ return d << (e = c * 8) | a & ~(255 << e); } }; }(),dat.color.toString,dat.utils.common),dat.color.interpret,dat.utils.common),dat.utils.requestAnimationFrame = function(){ return window.webkitRequestAnimationFrame ||
